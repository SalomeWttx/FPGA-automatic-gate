...
--  GestionTelecommunications (GestionTelecommunications.vhd)
--  GestionBoutons (GestionBoutons.vhd)
----------------------------------------------------------------------------------
...
entity Auth is
    ...
    Port ( 
        ...
        LEDdigicode : out STD_LOGIC_VECTOR(4 downto 0) --5 LED indiquant quelle fonction du digicode est en train d'être utilisée (par exemple changer le code, ouvrir le portail...)
    );
end Auth;
