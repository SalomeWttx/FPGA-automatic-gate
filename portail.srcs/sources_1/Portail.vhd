...
entity Portail is
    ...
    Port ( 
        ...
        lignes : out STD_LOGIC_VECTOR (3 downto 0); --lignes du clavier (mises une à une à l'état logique '1')
...
architecture Behavioral of Portail is
    ...
    --Signal de fin de course qui sera envoyé dans CtrlPortail
    signal FinDeCourseSignal : STD_LOGIC_VECTOR (1 downto 0);
begin
    FinDeCourseSignal(0) <= not(FinDeCourse(0)); --On s'est trompé dans le montage du capteur donc les niveaux logiques sont inversés
