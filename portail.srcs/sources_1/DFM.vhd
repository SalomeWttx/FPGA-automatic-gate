...
-- Target Devices: 
-- Tool Versions: 
-- Description: générateur (ou extracteur) de front montant : prend un signal quelconque en entrée, en donne en sortie '1' pendant une période d'horloge au moment du front montant de l'entrée
-- 
----------------------------------------------------------------------------------
